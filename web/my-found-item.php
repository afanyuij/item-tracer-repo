<body class="bg-gray-50">
    ...
    $sql = "SELECT * FROM documents WHERE UserID='$user_id' and DocumentStatus='Found'";
                ...
                <div class="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    if (isset($_GET['search'])) {
                            ...
                            while ($searchval = $result_search->fetch_assoc()) {
                                ...
                                <div class="bg-white rounded-lg p-4 shadow-sm">
                                    <div class="aspect-square bg-gray-100 rounded-lg mb-4 flex items-center justify-center text-gray-400">
                                        <img src="./image/<?php echo $searchval['found_img']; ?>" alt="Lost Item Image">
                                    </div>
                        ...
                        while ($info = $result->fetch_assoc()) {
                            ...
                            <div class="bg-white rounded-lg p-4 shadow-sm">
                                <div class="aspect-square bg-gray-100 rounded-lg mb-4 flex items-center justify-center text-gray-400">
                                    <img src="./<?php echo $info['found_img']; ?>" alt="Found Item Image">
                                </div>
                                <div class="flex justify-between items-center w-full">

                                    <h3 class="font-medium mb-2  w-[80%]"><?php echo $info['OwnerName']; ?></h3>
                                    <div class="p-2 w-[20%] text-center bg-slate-200 rounded-xl color-gray-900">
                                        <?php echo $info['DocumentStatus'] ?>
                                    </div>
                                </div>
